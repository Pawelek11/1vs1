            ...
            newData.forEach(player => {               
                ...
                if (existingPlayer) {                   
                    if (player.wins > existingPlayer.wins) {                 // Sprawdź, czy nowe wygrane są większe niż aktualne
                        ...
                        updateInfo.textContent = `${new Date().toLocaleString()} ${player.name }, Wygrane: ${player.wins }` //, Nowe wygrane: +${winDifference}, ${additionalWinsText}`;
                    ...
                    addInfo.textContent = `N: ${new Date().toLocaleString()}, ${player.name}, Wygrane: ${player.wins}`;
                    output1Div.appendChild(addInfo);
                }
            });
...
const data = [
    ...
    { name: "pcku", wins: 16, additionalWins: [[1721454000, 0, 0]] },
    ...
    { name: "Canserbero", wins: 6, additionalWins: [[1721454000, 0, 0],[1722414443,960443,2]] },
    ...
    { name: "E X O T I C", wins: 711, additionalWins: [[1721454000, 0, 0]] },
    ...
    { name: "squeruu", wins: 9, additionalWins: [[1721454000, 0, 0],[1722458461,1004461,1]] },
    ...
    { name: "Gracia", "wins": 50, additionalWins: [[1721653953, 0, 5], [1721700963, 47010, 1], [1721701323, 360, 1], [1722240516, 539193, 1]] },
    ...
    { name: "Shania ", "wins": 51, additionalWins: [[1721828777, 0, 1],[1723040989,1212212,1],[1723108454,67465,48]] },
    { name: "BANYAK BACOT", "wins": 107, additionalWins: [[1722071669, 0, 35], [1722240516, 168847, 61], [1723618593,1378077,9]] },
    { name: "P O L Y T R O N", "wins": 154, additionalWins: [[1722071669, 0, 43], [1722082621, 10952, 1], [1722082681, 60, 4], [1722082741, 60, 1], [1722082801, 60, 4], [1722082861, 60, 3], [1722082921, 60, 3], [1722082981, 60, 4], [1722083041, 60, 4], [1722083101, 60, 3], [1722083161, 60, 4], [1722083221, 60, 4], [1722083281, 60, 4], [1722083341, 60, 3], [1722083401, 60, 3], [1722083461, 60, 4], [1722083521, 60, 2], [1722083581, 60, 3], [1722083641, 60, 3], [1722083761, 120, 1]] },
    { name: "MASUKTV", "wins": 108, additionalWins: [[1722071669,0,15],[1722083641,11972,1],[1722083701,60,3],[1722083761,60,2],[1722110761,27000,2],[1722110821,60,4],[1722110881,60,2],[1722110941,60,3],[1722111001,60,3],[1722111061,60,4],[1722111073,12,1],[1722111094,21,1],[1722111114,20,1],[1722111134,20,1],[1722111181,47,2],[1722111241,60,4],[1722111295,54,1],[1722240883,129588,2],[1722240943,60,2],[1722241003,60,1],[1722458641,217638,1],[1722458645,4,1],[1722458762,117,2],[1722458821,59,2],[1722458881,60,1],[1722458898,17,1],[1722458925,27,1],[1722458944,19,1],[1722459001,57,1],[1722459061,60,1],[1722459121,60,1]]},
    { name: "Mayiq", "wins": 6, additionalWins: [[1722240516, 0, 6]] },
    { name: "KO","wins":55, additionalWins: [[1722423901,0,2],[1722423961,60,4],[1722424021,60,4],[1722424081,60,4],[1722424141,60,4],[1722424201,60,4],[1722424261,60,4],[1722424321,60,4],[1722424381,60,4],[1722424441,60,4],[1722424501,60,4],[1722424681,180,12],[1722424741,60,1]]},
    { name: "Fake Team","wins":1, additionalWins:[[1722414443,0,1]]},
    { name: "rere1402","wins":1, additionalWins:[[1722434101,0,1]]},
    { name: "UszatXD","wins":6, additionalWins:[[1722440221,0,1],[1722440582,361,1],[1723618593,1178011,2]]},
    { name: "JORDY JOT1","wins":48, additionalWins:[[1722750265,0,1],[1722750325,60,1],[1722750385,60,1],[1722750445,60,1],[1722750505,60,1],[1722750565,60,2],[1722750625,60,1],[1722750685,60,1],[1722750745,60,1],[1722750865,120,2],[1722750985,120,1],[1722751045,60,1],[1722751165,120,1],[1722846230,95065,33]]},
    { name: "Dhas Master YT","wins":1, additionalWins:[[1722846230,0,1]]},
    { name: "M I O MERAH","wins":22, additionalWins:[[1723040989,0,1],[1723204824,163835,13]]},
    { name: "IIIIIII D A N I A IIIIIII","wins":31, additionalWins:[[1723204824,0,5],[1723618593,413769,26]]},
    { name: "PETINGGI ELMO","wins":2, additionalWins:[[1723204824,0,2]]},
    { name: "SATURI","wins":159, additionalWins:[[1723618593,0,159]]},
    { name: "ZXVEGA","wins":5, additionalWins:[[1723618593,0,5]]},
    { name: "ddos","wins":5, additionalWins:[[1723618593,0,5]]},
    { name: "B A B I _LOVE","wins":5, additionalWins:[[1723618593,0,5]]},
    { name:"LH","wins":9, additionalWins:[[1724077006,0,9]]},
    {"name":"Ilergames","wins":1,"additionalWins":[[1724077006,0,1]]},
    {"name":"dawido182","wins":1,"additionalWins":[[1724077006,0,1]]}
];
